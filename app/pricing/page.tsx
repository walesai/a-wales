  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white py-24 px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-5xl font-bold mb-4 text-white">Simple Pricing</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 ring-2 ring-blue-500 relative">
            ...
            <div className="text-5xl font-bold mb-1 text-white">£4.99</div>
            ...
            <button className="block w-full py-4 bg-white text-black rounded-2xl font-medium">Subscribe Monthly</button>
          </div>

          {/* Annual */}
          <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-700">
            <h3 className="text-2xl font-semibold mb-2 text-white">Annual</h3>
            <div className="text-5xl font-bold mb-1 text-white">£49</div>
            ...
            <button className="block w-full py-4 border border-zinc-600 rounded-2xl font-medium text-white">Subscribe Annually</button>
          </div>
        </div>
      </div>
    </div>
